        ...
        <div class="row">
            <div class="col-md-12 heading">
                <h1 class="page-header">
                    <i class="en-vcard"></i> 个人信息 <a href="${pagePath}/user_modifyUser.do" class="btn btn-primary">
                    <span class="fa-edit"></span> 修改信息
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="height: 550px; padding-top: 155px;">
                            <div class="row">
