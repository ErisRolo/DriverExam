                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">考试试题</h4>
                        </div>
                        <div class="panel-body" style="height: 550px;">
                            <form class="form-horizontal" action="${pagePath}/user_mockTest.do" method="post">
                                <input type="hidden" name="problemIds" value="${problemIds}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-4 col-md-8">
                                        <label class="radio"> <input type="radio" name="answer"
                                                                     value="A">${problem.optionA}</label> <label
                                            class="radio"> <input type="radio" name="answer"
                                                                  value="B">${problem.optionB}</label> <label
                                            class="radio"> <input type="radio" name="answer"
                                ...
                                <div class="form-group" style="margin-top: 50px; text-align: center;">
                                    <div class="col-md-offset-4 col-md-4">
                                        <c:if test="${number ne '10'}">
                                            <button class="btn btn-primary col-md-offset-1 col-md-8" type="button"
                                                    onclick="checkSubmit()">下一题
                                            </button>
                                        </c:if>
                                        <c:if test="${number eq '10'}">
                                            <button class="btn btn-primary col-md-offset-1 col-md-8" type="button"
                                                    onclick="checkSubmit()">交卷
                                            </button>
                                        </c:if>
                                    </div>
                                </div>
