        ...
        <div class="row">
            <div class="col-md-12 heading">
                <h1 class="page-header">
                    <i class="im-users"></i> 新增用户
                </h1>
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">录入用户资料</h4>
                        </div>
                        <div class="panel-body" style="height: 550px; padding-top: 45px;">
                            <form class="form-horizontal" action="${pagePath}/admin_addUser.do" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" id="username" name="username"
                                               value="${user.username}" placeholder="请输入用户名" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="password" id="password" name="password"
                                               value="${user.password}" placeholder="请输入密码" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" id="mobile" name="mobile"
                                               value="${user.mobile}" placeholder="请输入手机号" maxlength="11"
